...
| ![raw.png](docs/raw.png) | ![hsv_bin.png](docs/hsv_bin.png) | ![gray_bin.png](docs/gray_bin.png) |
| :---------------: | :-------------------: | :--------------------: |
|       原图        |    通过颜色二值化     |     通过灰度二值化     |
...
| ![red.png](docs/red.png) | ![blue.png](docs/blue.png) |
| :---------------: | :----------------: |
| 提取出的红色灯条  |  提取出的蓝色灯条  |
...
| ![num_raw.png](docs/num_raw.png) | ![num_warp.png](docs/num_warp.png) | ![num_roi.png](docs/num_roi.png) | ![num_bin.png](docs/num_bin.png) |
| :-------------------: | :--------------------: | :-------------------: | :-------------------: |
|         原图          |        透视变换        |         取ROI         |        二值化         |
